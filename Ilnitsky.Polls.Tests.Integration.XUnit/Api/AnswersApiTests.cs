...
public class AnswersApiTests(AppFixture fixture)
{
    ...
    public async Task CreateRespondentAnswer_SavesToDatabase_WhenAllowCustomAnswer()
    {
        ...
        using var httpClient = Factory.GetHttpClientWithCookies();
    ...
    public async Task Middleware_ShouldNotRecreate_RespondentId_IfItExists()
    {
        ...
        using var httpClient = Factory.GetHttpClientWithCookieContainer(container);
    ...
    [Theory]
    [InlineData("019c1aa8-9bf0-750d-1111-832de94b1c13")]
    [InlineData("019c1aa8-9bf0-750d-2222-832de94b1c13")]
    public async Task RespondentId_ArePersistent_FromCookie(Guid respondentId)
    {
        ...
        using var httpClient = Factory.GetHttpClientWithCookieContainer(cookieContainer);
