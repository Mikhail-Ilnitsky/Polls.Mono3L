...
{
    public WebApplicationFactory<Program> Factory { private set; get; } = null!;
    public HttpClient HttpClient { private set; get; } = null!;
    public string DbConnectionString { private set; get; } = null!;

    private readonly MariaDbContainer MariaDbContainer = new MariaDbBuilder()
